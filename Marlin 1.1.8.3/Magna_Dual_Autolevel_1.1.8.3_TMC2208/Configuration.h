...
#define CUSTOM_MACHINE_NAME "Magna Dual"
...
#define PREVENT_COLD_EXTRUSION  //jone181121
...
#if 1 //Ender 3 settings
/**
 * Default Axis Steps Per Unit (steps/mm)
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 395 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps //395 for Geetech extruder
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.8, 400, 96 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps //395 for Geetech extruder
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 } A20M
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION       { 500, 500, 100, 1000 } //1.0.3 { 3000, 3000, 100, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves        //1.0.3 3000
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts                          //1.0.3 3000
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 395 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 25 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION       { 1000, 1000, 100, 1000 } //1.0.3 { 3000, 3000, 100, 10000 }
...
#define DEFAULT_RETRACT_ACCELERATION  1000    // E acceleration for retracts                          //1.0.3 3000
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves //1.0.3 3000
