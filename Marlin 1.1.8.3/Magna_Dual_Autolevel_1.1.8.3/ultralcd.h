...
#include "MarlinConfig.h"
  ...
  #define LCD_UPDATE_REFRESH_INTERVAL 1000
  ...
  inline void lcd_setforcestatusPGM(const char* const message, const int8_t level=0) { UNUSED(message); UNUSED(level); }
...
#define LCD_FORCEMESSAGEPGM(x)      lcd_setforcestatusPGM(PSTR(x))
